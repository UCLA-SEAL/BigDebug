 ...
 */
public class Int2IntOpenHashSetHashMap extends AbstractInt2ObjectMap<IntOpenHashSet> implements java.io.Serializable, Cloneable, Hash {
    private static final long serialVersionUID = 0L;
    private static final boolean ASSERTS = false;
    /** The array of keys. */
    protected transient int[] key;
    /** The array of values. */
    protected transient IntOpenHashSet[] value;
    ...
    protected transient volatile FastEntrySet <IntOpenHashSet> entries;
    /** Cached set of keys. */
    protected transient volatile IntSet keys;
    /** Cached collection of values. */
    protected transient volatile ObjectCollection <IntOpenHashSet> values;
    ...
    public Int2IntOpenHashSetHashMap(final int expected, final float f) {
        ...
        maxFill = maxFill( n, f );
        key = new int[ n + 1 ];
        value = new IntOpenHashSet[ n + 1 ];
        for ( int i = 0; i < n + 1; i++) value [ i ] = new IntOpenHashSet();
    }
    /** Creates a new hash map with {@link it.unimi.dsi.fastutil.Hash#DEFAULT_LOAD_FACTOR} as load factor.
     *
     * @param expected the expected number of elements in the hash map.
     */
    public Int2IntOpenHashSetHashMap(final int expected) {
     ...
     */
    public Int2IntOpenHashSetHashMap() {
     ...
     * @param f the load factor.
     */
    public Int2IntOpenHashSetHashMap(final Map<? extends Integer, ? extends IntOpenHashSet> m, final float f) {
        this( m.size(), f );
        putAll( m );
    }
     ...
     * @param m a {@link java.util.Map} to be copied into the new hash map.
     */
    public Int2IntOpenHashSetHashMap(final Map<? extends Integer, ? extends IntOpenHashSet> m) {
     ...
     * @param f the load factor.
     */
    public Int2IntOpenHashSetHashMap(final Int2ObjectMap<IntOpenHashSet> m, final float f) {
        this( m.size(), f );
        putAll( m );
    }
     ...
     * @param m a type-specific map to be copied into the new hash map.
     */
    public Int2IntOpenHashSetHashMap(final Int2ObjectMap<IntOpenHashSet> m) {
        this( m, DEFAULT_LOAD_FACTOR );
    }
     ...
     */
    public Int2IntOpenHashSetHashMap(final int[] k, final IntOpenHashSet[] v, final float f) {
        this( k.length, f );
     ...
     * @throws IllegalArgumentException if <code>k</code> and <code>v</code> have different lengths.
     */
    public Int2IntOpenHashSetHashMap(final int[] k, final IntOpenHashSet[] v) {
    ...
    private IntOpenHashSet removeEntry( final int pos ) {
        final IntOpenHashSet oldValue = value[ pos ];
        value[ pos ] = (null);
        size--;
        shiftKeys( pos );
    ...
    private IntOpenHashSet removeNullEntry() {
        containsNullKey = false;
        final IntOpenHashSet oldValue = value[ n ];
        value[ n ] = (null);
        size--;
        if ( size < maxFill / 4 && n > DEFAULT_INITIAL_SIZE ) rehash( n / 2 );
        return oldValue;
    ...
    /** {@inheritDoc} */
    public void putAll(Map<? extends Integer,? extends IntOpenHashSet> m) {
    ...
    public IntOpenHashSet put(final int k, final int v) {
    ...
    public IntOpenHashSet put( final Integer ok, final Integer ov ) {
    ...
    public IntOpenHashSet remove( final int k ) {
        if ( ( (k) == (0) ) ) {
    ...
    public IntOpenHashSet remove( final Object ok ) {
    ...
    public IntOpenHashSet get( final Integer ok ) {
    ...
    public IntOpenHashSet get( final int k ) {
    ...
    public boolean containsValue( final Object v ) {
        final IntOpenHashSet value[] = this.value;
        final int key[] = this.key;
     ...
     * the map */
    final class MapEntry implements Entry <IntOpenHashSet>, Map.Entry<Integer, IntOpenHashSet> {
        ...
        public IntOpenHashSet setValue( final IntOpenHashSet v ) {
            final IntOpenHashSet oldValue = value[ index ];
            value[ index ] = v;
            return oldValue;
        }
        @SuppressWarnings("unchecked")
        public boolean equals( final Object o ) {
            ...
            Map.Entry<Integer, IntOpenHashSet> e = (Map.Entry<Integer, IntOpenHashSet>)o;
    ...
    private class MapIterator {
        ...
        boolean mustReturnNullKey = Int2IntOpenHashSetHashMap.this.containsNullKey;
        ...
        public int nextEntry() {
            ...
            final int key[] = Int2IntOpenHashSetHashMap.this.key;
            for(;;) {
                if ( --pos < 0 ) {
        ...
        public void remove() {
            ...
            if ( last == n ) {
                ...
                Int2IntOpenHashSetHashMap.this.remove( wrapped.getInt( - pos - 1 ) );
    ...
    private class EntryIterator extends MapIterator implements ObjectIterator<Entry <IntOpenHashSet> > {
        private MapEntry entry;
        public Entry <IntOpenHashSet> next() {
    ...
    private class FastEntryIterator extends MapIterator implements ObjectIterator<Entry <IntOpenHashSet> > {
    ...
    private final class MapEntrySet extends AbstractObjectSet<Entry <IntOpenHashSet> > implements FastEntrySet <IntOpenHashSet> {
        public ObjectIterator<Entry <IntOpenHashSet> > iterator() {
            return new EntryIterator();
        }
        public ObjectIterator<Entry <IntOpenHashSet> > fastIterator() {
            return new FastEntryIterator();
        }
        @SuppressWarnings("unchecked")
        public boolean contains( final Object o ) {
            if ( !( o instanceof Map.Entry ) ) return false;
            final Map.Entry<Integer, IntOpenHashSet> e = (Map.Entry<Integer, IntOpenHashSet>)o;
            final int k = ((e.getKey()).intValue());
            if ( ( (k) == (0) ) ) return ( Int2IntOpenHashSetHashMap.this.containsNullKey && ( (value[ n ]) == null ? ((e.getValue())) == null : (value[ n ]).equals((e.getValue())) ) );
            int curr;
            final int[] key = Int2IntOpenHashSetHashMap.this.key;
            int pos;
            // The starting point.
        ...
        public boolean remove( final Object o ) {
            ...
            final Map.Entry<Integer, IntOpenHashSet> e = (Map.Entry<Integer, IntOpenHashSet>)o;
            final int k = ((e.getKey()).intValue());
            final IntOpenHashSet v = (e.getValue());
            if ( ( (k) == (0) ) ) {
        ...
        public void clear() {
            Int2IntOpenHashSetHashMap.this.clear();
        }
    }
    public FastEntrySet <IntOpenHashSet> int2ObjectEntrySet() {
    ...
    private final class KeySet extends AbstractIntSet {
        ...
        public boolean remove( int k ) {
            ...
            Int2IntOpenHashSetHashMap.this.remove( k );
            return size != oldSize;
        }
        public void clear() {
            Int2IntOpenHashSetHashMap.this.clear();
     ...
     * instead of entries.
     */
    private final class ValueIterator extends MapIterator implements ObjectIterator <IntOpenHashSet> {
        public ValueIterator() { super(); }
        public IntOpenHashSet next() { return value[ nextEntry() ]; }
    }
    public ObjectCollection <IntOpenHashSet> values() {
        if ( values == null ) values = new AbstractObjectCollection <IntOpenHashSet>() {
            public ObjectIterator <IntOpenHashSet> iterator() {
    ...
    protected void rehash( final int newN ) {
        ...
        final IntOpenHashSet newValue[] = (IntOpenHashSet[]) new Object[ newN + 1 ];
        int i = n, pos;
     ...
     */
    @SuppressWarnings("unchecked")
    public Int2IntOpenHashSetHashMap clone() {
        Int2IntOpenHashSetHashMap c;
        try {
            c = (Int2IntOpenHashSetHashMap)super.clone();
        }
    ...
    private void readObject(java.io.ObjectInputStream s) throws java.io.IOException, ClassNotFoundException {
        ...
        final IntOpenHashSet value[] = this.value = (IntOpenHashSet[]) new Object[ n + 1 ];
        int k;
        IntOpenHashSet v;
        for( int i = size, pos; i-- != 0; ) {
            k = s.readInt();
            v = (IntOpenHashSet) s.readObject();
            if ( ( (k) == (0) ) ) {
                pos = n;
                containsNullKey = true;
            }
