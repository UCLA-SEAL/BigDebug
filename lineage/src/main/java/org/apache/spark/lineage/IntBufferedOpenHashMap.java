 ...
 */
public class IntBufferedOpenHashMap extends AbstractInt2ObjectMap<java.util.AbstractCollection<Integer>> implements java.io.Serializable, Cloneable, Hash {
    private static final long serialVersionUID = 0L;
    private static final boolean ASSERTS = false;
    /** The array of keys. */
    protected transient int[] key;
    /** The array of values. */
    protected transient java.util.AbstractCollection<Integer>[] value;
    /** The array of values. */
    ...
    protected transient volatile FastEntrySet <java.util.AbstractCollection<Integer>> entries;
    /** Cached set of keys. */
    protected transient volatile IntSet keys;
    /** Cached collection of values. */
    protected transient volatile ObjectCollection <java.util.AbstractCollection<Integer>> values;
    ...
    public IntBufferedOpenHashMap(final int expected, final float f) {
     ...
     * @param f the load factor.
     */
    public IntBufferedOpenHashMap(final Map<? extends Integer, ? extends java.util.AbstractCollection<Integer>> m, final float f) {
        this( m.size(), f );
        putAll( m );
    }
     ...
     * @param m a {@link java.util.Map} to be copied into the new hash map.
     */
    public IntBufferedOpenHashMap(final Map<? extends Integer, ? extends java.util.AbstractCollection<Integer>> m) {
     ...
     * @param f the load factor.
     */
    public IntBufferedOpenHashMap(final Int2ObjectMap<java.util.AbstractCollection<Integer>> m, final float f) {
        this( m.size(), f );
        putAll( m );
    }
     ...
     * @param m a type-specific map to be copied into the new hash map.
     */
    public IntBufferedOpenHashMap(final Int2ObjectMap<java.util.AbstractCollection<Integer>> m) {
        this( m, DEFAULT_LOAD_FACTOR );
    }
     ...
     */
    public IntBufferedOpenHashMap(final int[] k, final ArrayDeque[] v, final float f) {
        this( k.length, f );
     ...
     * @throws IllegalArgumentException if <code>k</code> and <code>v</code> have different lengths.
     */
    public IntBufferedOpenHashMap(final int[] k, final ArrayDeque[] v) {
    ...
    /** {@inheritDoc} */
    public void putAll(Map<? extends Integer,? extends java.util.AbstractCollection<Integer>> m) {
    ...
    private int insert(final int k, final int v) {
        ...
        buffer.putInt( v );
        index += 4;
        if(index > 64 * 1024 * 1024) System.out.print("Grow");
    ...
    public java.util.AbstractCollection<Integer> get( final Integer ok ) {
    ...
    public java.util.AbstractCollection<Integer> get( final int k ) {
    ...
    public boolean containsValue( final Object v ) {
        final java.util.AbstractCollection<Integer> value[] = this.value;
        final int key[] = this.key;
     ...
     * the map */
    final class MapEntry implements Entry <java.util.AbstractCollection<Integer>>, Map.Entry<Integer, java.util.AbstractCollection<Integer>> {
        ...
        public java.util.AbstractCollection<Integer> getValue() {
            return (value[ index ]);
        }
        public java.util.AbstractCollection<Integer> setValue( final java.util.AbstractCollection<Integer> v ) {
            final java.util.AbstractCollection<Integer> oldValue = value[ index ];
            value[ index ] = v;
            return oldValue;
        }
        @SuppressWarnings("unchecked")
    ...
    private class MapIterator {
        ...
        boolean mustReturnNullKey = IntBufferedOpenHashMap.this.containsNullKey;
        ...
        public int nextEntry() {
            ...
            final int key[] = IntBufferedOpenHashMap.this.key;
            for(;;) {
                if ( --pos < 0 ) {
        ...
        public void remove() {
            ...
            if ( last == n ) {
                ...
                IntBufferedOpenHashMap.this.remove( wrapped.getInt( - pos - 1 ) );
    ...
    private class EntryIterator extends MapIterator implements ObjectIterator<Entry <java.util.AbstractCollection<Integer>> > {
        private MapEntry entry;
        public Entry <java.util.AbstractCollection<Integer>> next() {
    ...
    private class FastEntryIterator extends MapIterator implements ObjectIterator<Entry <java.util.AbstractCollection<Integer>> > {
    ...
    private final class MapEntrySet extends AbstractObjectSet<Entry <java.util.AbstractCollection<Integer>> > implements FastEntrySet <java.util.AbstractCollection<Integer>> {
        public ObjectIterator<Entry <java.util.AbstractCollection<Integer>> > iterator() {
            return new EntryIterator();
        }
        public ObjectIterator<Entry <java.util.AbstractCollection<Integer>> > fastIterator() {
        ...
        public boolean contains( final Object o ) {
            ...
            if ( ( (k) == (0) ) ) return ( IntBufferedOpenHashMap.this.containsNullKey && ( (value[ n ]) == null ? ((e.getValue())) == null : (value[ n ]).equals((e.getValue())) ) );
            int curr;
            final int[] key = IntBufferedOpenHashMap.this.key;
            int pos;
            // The starting point.
        ...
        public void clear() {
            IntBufferedOpenHashMap.this.clear();
        }
    }
    public FastEntrySet <java.util.AbstractCollection<Integer>> int2ObjectEntrySet() {
    ...
    private final class KeySet extends AbstractIntSet {
        ...
        public boolean remove( int k ) {
            ...
            IntBufferedOpenHashMap.this.remove( k );
            return size != oldSize;
        }
        public void clear() {
            IntBufferedOpenHashMap.this.clear();
     ...
     * instead of entries.
     */
    private final class ValueIterator extends MapIterator implements ObjectIterator <java.util.AbstractCollection<Integer>> {
        public ValueIterator() { super(); }
        public java.util.AbstractCollection<Integer> next() { return value[ nextEntry() ]; }
    }
    public ObjectCollection <java.util.AbstractCollection<Integer>> values() {
        if ( values == null ) values = new AbstractObjectCollection <java.util.AbstractCollection<Integer>>() {
            public ObjectIterator <java.util.AbstractCollection<Integer>> iterator() {
    ...
    protected void rehash( final int newN ) {
        ...
        final java.util.AbstractCollection<Integer> newValue[] = (java.util.AbstractCollection<Integer>[]) new Object[ newN + 1 ];
        int i = n, pos;
     ...
     */
    @SuppressWarnings("unchecked")
    public IntBufferedOpenHashMap clone() {
        IntBufferedOpenHashMap c;
        try {
            c = (IntBufferedOpenHashMap)super.clone();
        }
    ...
    private void readObject(java.io.ObjectInputStream s) throws java.io.IOException, ClassNotFoundException {
        ...
        final java.util.AbstractCollection<Integer> value[] = this.value = (java.util.AbstractCollection<Integer>[]) new Object[ n + 1 ];
        int k;
        ArrayDeque v;
