...
private[spark] object JsonProtocol {
  ...
  def sparkEventToJson(event: SparkListenerEvent): JValue = {
    event match {
      ...
      case taskSubmitted: SparkListenerTaskSubmitted =>
        taskSubmittedToJson(taskSubmitted)
  ...
  def taskSubmittedToJson(taskSubmitted: SparkListenerTaskSubmitted): JValue = {
    val taskInfo = taskSubmitted.taskInfo
    ("Event" -> Utils.getFormattedClassName(taskSubmitted)) ~
  ...
  def taskInfoToJson(taskInfo: TaskInfo): JValue = {
    ...
    ("Task Detailed Info" -> taskInfo.taskDetailInfo)
  ...
  def sparkEventFromJson(json: JValue): SparkListenerEvent = {
    ...
    val taskSubmitted = Utils.getFormattedClassName(SparkListenerTaskSubmitted)
    ...
    (json \ "Event").extract[String] match {
      ...
      case `taskSubmitted` => taskSubmittedFromJson(json)
  ...
  def taskSubmittedFromJson(json:JValue):SparkListenerTaskSubmitted = {
    val taskInfo = taskInfoFromJson(json \ "Task Info")
    SparkListenerTaskSubmitted(taskInfo)
  }
  ...
  def taskInfoFromJson(json: JValue): TaskInfo = {
    ...
    val taskType = (json \ "Task Type").extract[String]
    val taskDetailedInfo = (json \ "Task Detailed Info").extract[String]
    ...
    val taskInfo =
      new TaskInfo(taskId, index, attempt, launchTime, executorId, host, taskLocality, speculative, taskType, taskDetailedInfo)
