...
/**
 * Jason: Copied from ByteBuffer and modified to contain 4 values for performance tracking
 */
abstract class ExtendedByteBuffer2[@specialized(Long, Int) V1: ClassTag,
                                      @specialized(Long, Int) V2: ClassTag,
                                      @specialized(Long, Int) V3: ClassTag,
                                      @specialized(Long, Int) V4: ClassTag]
                                      (var data: Array[Byte]) {
  ...
  def put(value1: V1, value2: V2, value3: V3, value4: V4)
  ...
  def iterator: Iterator[(V1, V2, V3, V4)]
}
