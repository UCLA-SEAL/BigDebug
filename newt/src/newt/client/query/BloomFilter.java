...
public class BloomFilter<E> implements Serializable {
    ...
    /**
     * Performs a bit-wise OR operation with another bloom filter.
     * The result is stored in the current bloom filter.
     * Returns false if the bloom filters are incompatible (different
     * number of bits or different number of hash functions) and true
     * if the union was successful.
     */
    public boolean union(BloomFilter other) {
	if ((this.getK() != other.getK()) || (this.size()!=other.size())) {
	    return false;
	}
