...
object HistogramRatingsVega {
  ...
  def main(args: Array[String]) {
    try {
      ...
      val delta_debug = new DDNonExhaustiveVega[String , (Int,Int)]
  ...
  def inverse(rdd1: Array[(Int,Int)]  , rdd2:Array[(Int,Int)]): Array[(Int, Int)] ={
    val map1 = scala.collection.mutable.HashMap[Int, Int]()
